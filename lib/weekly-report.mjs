/**
 * WGS APS DSR weekly report — analysis + HTML builder
 * Used by scripts/preview-email.mjs; synced into n8n Code nodes via scripts/sync-n8n-from-lib.mjs
 */

export const DSR_SUMKCS = [
...
export const PEN_TARGETS = { Decor: 0.345, Softhome: 0.245, Rugs: 0.093 };

export const VERTICAL_BENCHMARK = {
...
export function diagnoseDrivers(row, opts = {}) {
  const drivers = [];
...
export function explainChange(entity, label) {
...
export function analyzeWeeklyRows(rows) {
...
export function buildHtmlEmail(data) {
